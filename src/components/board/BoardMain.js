            ...
            <Card.Header className='border-0 pt-6'>
              <Card.Title className='flex-wrap'>
                ...
                <div className="d-flex align-items-center my-1">
                  ...
                  <input type="text" id="searchTxt" data-kt-user-table-filter="search" className="form-control form-control-solid w-400px ps-14" placeholder="검색어를 입력하세요." />
                </div>
              </Card.Title>
            </Card.Header>
            {boardInfo.userRud > 4 && (
            <Link to={`${boardId}/write`} className="btn btn-primary er fs-6 px-8 py-4">
              글쓰기
            </Link>)}
          </Card>
            <p>{boardId}</p>
